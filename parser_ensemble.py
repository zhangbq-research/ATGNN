...
def get_parser(root_dir='.'):
    ...
    parser.add_argument("--n-shot-test", type=int, default=1, help="test: number of shot for each class")#choices=[1,10]
    ...
    parser.add_argument('--pretrained_weight_path', type=str,
                        default=os.path.join(root_dir,'chem_lib/model_gin/{}.pth'), help='pretrained path')
    ...
    parser.add_argument("--tentimes", action="store_true")
    return parser
